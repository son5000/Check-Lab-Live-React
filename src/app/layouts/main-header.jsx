...
export function MainHeader({ headerState, currentDate, currentTime, isDarkMode, isSidebarCollapsed, isMobileSidebarOpen, onMenuToggle, onThemeToggle, }) {
    ...
    return (<header className="MainHeader MainHeader__header-1 grid h-14 shrink-0 grid-cols-[minmax(0,1fr)_auto_auto] items-center gap-2 overflow-hidden border-b border-border bg-background px-2.5 md:px-3 xl:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]">
