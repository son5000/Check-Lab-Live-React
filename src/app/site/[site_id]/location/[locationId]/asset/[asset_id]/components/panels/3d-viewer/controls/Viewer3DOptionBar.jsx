...
export function Viewer3DOptionBar({ afterCameraControls, beforeControls, children, className, config, modelFile, onConfigChange, onModelFileChange, showCameraControls = true, showWorldControls = true, }) {
